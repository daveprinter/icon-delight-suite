...
import primeTechLogo from "@/assets/primetech-logo-lockup.png";

function BrandMark() {
  return <Link to="/" className="inline-flex bg-brand-foreground p-1" aria-label="PrimeTech Digital Solutions home"><img src={primeTechLogo} alt="PrimeTech Digital Solutions" width={912} height={326} className="h-10 w-auto" /></Link>;
}
